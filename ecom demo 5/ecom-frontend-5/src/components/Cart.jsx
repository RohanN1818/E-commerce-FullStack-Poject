...
//   //             `https://e-commerce-backend-project-3lzz.onrender.com/api/product/${item.id}/image`,
//   //             { responseType: "blob" }
//   //           );
...
//         await axios
//           .put(`https://e-commerce-backend-project-3lzz.onrender.com/api/product/${item.id}`, cartProduct, {
//             headers: {
